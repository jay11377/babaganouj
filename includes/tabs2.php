<div class="row" id="menuTabs">
	<div class="col-md-12">
		<ul id="myTab" class="nav nav-tabs">		   
			<?php
			$query_cat="SELECT id,name FROM categories WHERE active=1 AND id=".(int)$_GET['id']." ORDER BY order_position";
		...
		<div id="myTabContent" class="tab-content">
			...
			{ ?>
				<div class="tab-pane fade in<?php echo ($i==0)?' active':'' ?>" id="<?php echo str2url($row_cat['name']) ?>">
					<div class="row">
						<?php
						$query="SELECT * FROM plats WHERE id_categorie=".(int)$_GET['id']." AND active=1 ORDER BY order_position";
