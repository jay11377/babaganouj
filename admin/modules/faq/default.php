...
<div class="box">
	<div class="header">
        ...
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=add"><?php showLang('ADD_QUESTION') ?></a>
         <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=listsorted"><?php showLang('REORDER_QUESTIONS') ?></a>
    </div>
    <div class="container">		
    	 <table cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    <td><?php showLang('QUESTION') ?></td>
                ...
                <?php
                    ...
                    ?>
                        <tr class="<?php echo $class; ?>">
                            <td valign="top">
                            	<a href="moduleinterface.php?module=plats&amp;action=default&amp;id_categorie=<?php echo $row['id']; ?>" title="<?php showLang('VIEW') ?>"><?php echo osql($row['question']); ?></a>
                            </td>
                            <td><?php
