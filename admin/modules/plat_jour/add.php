...
<div class="box">
	<div class="header">
    	<h3><?php showLang('ADD_DISH_DAY') ?></h3>
    </div>
    <div class="container"><?php	
		$connector = new DbConnector();
		$result_plat = $connector->query("SELECT * FROM plats ORDER BY name");
		...
		// Validate the entries
			...
			if ( $validator->foundErrors() ){
				...
				// Insertion
				$query = "INSERT INTO $module (id_plat, name, photo, thumbnail, order_position, active) VALUES (".
				$id_plat.", ".
				"'".isql($name)."', ".
				"'".$full_dbpath."', ".
				"'".$thumbdbpath."', ".
