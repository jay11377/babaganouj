...
<div class="box">
	<div class="header">
    	<h3><?php showLang('DISH_DAY') ?></h3>
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=add"><?php showLang('ADD_DISH_DAY') ?></a>
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=listsorted"><?php showLang('REORDER_DISH_DAY') ?></a>
    </div>
    <div class="container">		
