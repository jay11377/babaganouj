...
$pagetitle=getLang('ORDER_ONLINE');
...
<div class="box">
	<div class="header">
    	<h3><?php showLang('ORDER_ONLINE') ?></h3>
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=add"><?php showLang('ADD_ORDER_ONLINE_PICTURE') ?></a>
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=listsorted"><?php showLang('REORDER_ORDER_ONLINE') ?></a>
    </div>
    <div class="container">		
