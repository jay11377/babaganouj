...
if(isset($_POST['save']) && stripslashes($_POST['save'])==getLang('SAVE_LIST_ORDER')){
	...
	sortdata("options_items","id_option",$sortedlist);
...
$result = $connector->query("SELECT * FROM options,options_items where options.id = options_items.id_option ORDER BY order_position");
?>
