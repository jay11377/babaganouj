...
<div class="box">
	<div class="header">
        ...
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=add"><?php showLang('ADD_VIDEO') ?></a>
         <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=listsorted"><?php showLang('REORDER_VIDEOS') ?></a>
    </div>
    <div class="container">		
    	 <table cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    ...
                    <td><?php showLang('SHORT_DESCRIPTION') ?></td>
                ...
                <?php
                    ...
                    ?>
                        <tr class="<?php echo $class; ?>">
                             <td><img src="../<?php echo $row['video_thumb'] ?>" /></td>		
                             <td>
                                <a class="image" href="moduleinterface.php?module=<?php echo $module; ?>&action=edit&id=<?php echo $row['id']; ?>" title="<?php showLang('EDIT') ?>"><?php echo osql($row['title']); ?></a>
                            </td>
                            <td>
								<?php echo osql($row['short_description']); ?>
                            </td>
                            <td><?php
