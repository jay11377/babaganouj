...
<div class="box">
	<div class="header">
        ...
        <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=add"><?php showLang('ADD_CATEGORY') ?></a>
         <a class="button small alt" href="moduleinterface.php?module=<?php echo $module; ?>&action=listsorted"><?php showLang('REORDER_CATEGORIES') ?></a>
    </div>
    <div class="container">		
                ...
                <?php
                    ...
                    ?>
                        <tr class="<?php echo $class; ?>">
                             <td><? if ($row['thumbnail']): ?><img src="../<?php echo $row['thumbnail'] ?>" /><?php endif; ?></td>
                            <td valign="top">
                            	<a href="moduleinterface.php?module=plats&amp;action=default&amp;id_categorie=<?php echo $row['id']; ?>" title="<?php showLang('VIEW') ?>"><?php echo osql($row['name']); ?></a>
                            </td>
                            <td><?php
